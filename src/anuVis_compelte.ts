...
import { Vector3, ExecuteCodeAction, ActionManager, StandardMaterial, Color3} from '@babylonjs/core';
...
export function anuVis(scene){
  ...
  hoverMaterial.diffuseColor = Color3.Red();
